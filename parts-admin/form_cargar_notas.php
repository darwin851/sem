				...
				<div class="module-wrapper">
					<section class="module alto_general module-has-footer module-projects-overview">
						<div class="module-inner">
							...
							<form role="form" name="cargar_notas" action="#" method="post">
								<div class="module-content collapse in" id="content-overview">
									<div class="module-content-inner sectionone col-md-6">
										...
										<div class="form-group row">
											...
											<div class="col-10">
												<select class="cursos form-control" name="taller_curso_select" id="taller_curso_select">
										...
										<div class="form-group row">
											<label for="archivo_notas" class="col-2 col-form-label">Seleccionar un archivo</label>
											<div class="col-10">
												<input type="file" class="form-control-file" id="archivo_notas">
											</div>
										</div>
									</div>
...
<!-- estos botones se muestran hasta abajo -->
									<button type="submit" class="btn btn-primary" onclick="procesarFormularioCarga('previsualizar_notas'); return false;">Previsualizar</button>
									<button type="submit" class="btn btn-primary" onclick="procesarFormularioCarga('cargar_notas'); return false;">Cargar archivo</button>
...
<script type="text/javascript">
	...
	function procesarFormularioCarga(modo){
		...
		if($('#archivo_notas').val()=='' || $('#archivo_notas').val().substr(-5).toLowerCase()!='.xlsx'){
...
//no me agrada esta forma de cargar el archivo
			...
			formData.append("userfile", document.getElementById('archivo_notas').files[0]);

			var request = new XMLHttpRequest();
			request.open("POST", "parts-admin/cargar_notas.php");
